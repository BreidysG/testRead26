document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
        {
            question: "¿Quién es el protagonista de la historia?",
            answers: [
                "El niño",
                "El viejo",
                "El niño y el viejo",
            ...
            correctAnswer: "El niño y el viejo"
        },
        {
            question: "¿Qué es un galeón?",
            answers: [
                "Un barco antiguo",
                "Una lancha de pesca",
                "Un barco pirata",
            ...
            correctAnswer: "Un barco antiguo"
        },
        {
            question: "¿Según el viejo, qué trae el galeón que sacan del fondo del mar?",
            answers: [
                "Juguetes, regalos, mujeres, etc.",
                "Oro, joyas, peces, etc.",
                "Cofres, vajillas, arcabuces, etc.",
                "Piratas, armas, animales, etc."
            ],
            correctAnswer: "Cofres, vajillas, arcabuces, etc."
        },
        {
            question: "¿Según el viejo, qué juguetes le regalaron en la infancia que no se rompieron?",
            answers: [
                "Cuentos narrados",
                "Libros",
                "Carros",
            ...
            correctAnswer: "Cuentos narrados"
        },
        {
            question: "¿Cuál es el regalo que el viejo le da al niño para que lo recuerde siempre?",
            answers: [
                "Cofres con monedas de oro",
                "Juguetes",
                "Cuentos narrados",
                "Un viaje a la playa"
            ],
